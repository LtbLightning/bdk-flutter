...
impl Wallet {
   ...
   pub fn get_network(&self)-> Network{
    ...
    pub fn get_descriptor_for_keychain(&self, keychain_kind:KeychainKind) -> Result<String, Error> {
        Ok(self.get_wallet().get_descriptor_for_keychain(keychain_kind).to_string())
    }
    ...
    pub fn get_internal_address(&self, address_index: AddressIndex) -> Result<AddressInfo, BdkError> {
        self.get_wallet()
    ...
    pub(crate) fn get_transaction(&self, txid_str: String, ) -> Result<Option<TransactionDetails>, Error> {
...
impl TxBuilder {
  ...
  pub  fn drain_wallet(&self) -> Arc<Self> {
   ...
   pub fn drain_to(&self, address: String) -> Arc<Self> {
        Arc::new(TxBuilder {
