...
fn wire_estimate_fee_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        ...
        move || {
            ...
            let api_blockchain = blockchain.wire2api();
            move |task_callback| Ok(estimate_fee(api_target, api_blockchain))
        },
    )
}
fn wire_broadcast_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        ...
        move || {
            ...
            let api_blockchain = blockchain.wire2api();
            move |task_callback| Ok(broadcast(api_tx, api_blockchain))
        },
    )
}
...
fn wire_max_satisfaction_weight_impl(
    port_: MessagePort,
    descriptor: impl Wire2Api<RustOpaque<BdkDescriptor>> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "max_satisfaction_weight",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_descriptor = descriptor.wire2api();
            move |task_callback| Ok(max_satisfaction_weight(api_descriptor))
        },
    )
}
...
fn wire_descriptor_secret_from_string_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        ...
        move || {
            ...
            move |task_callback| Ok(descriptor_secret_from_string(api_xprv))
        },
    )
}
...
fn wire_descriptor_public_from_string_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        ...
        move || {
            let api_public_key = public_key.wire2api();
            move |task_callback| Ok(descriptor_public_from_string(api_public_key))
        },
    )
}
...
fn wire_get_internalized_address_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        ...
        move || {
            let api_wallet = wallet.wire2api();
            let api_address_index = address_index.wire2api();
            move |task_callback| Ok(get_internalized_address(api_wallet, api_address_index))
        },
    )
}
...
fn wire_sign_impl(
    ...
    wallet: impl Wire2Api<RustOpaque<WalletInstance>> + UnwindSafe,
    psbt_str: impl Wire2Api<String> + UnwindSafe,
    trust_witness_utxo: impl Wire2Api<bool> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "sign",
        ...
        move || {
            let api_wallet = wallet.wire2api();
            let api_psbt_str = psbt_str.wire2api();
            let api_trust_witness_utxo = trust_witness_utxo.wire2api();
            move |task_callback| Ok(sign(api_wallet, api_psbt_str, api_trust_witness_utxo))
        },
    )
}
...
fn wire_get_descriptor_for_keychain_impl(
    port_: MessagePort,
    wallet: impl Wire2Api<RustOpaque<WalletInstance>> + UnwindSafe,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        ...
        move || {
            ...
            move |task_callback| Ok(get_descriptor_for_keychain(api_wallet, api_keychain))
        },
    )
}
fn wire_get_psbt_input_impl(
    port_: MessagePort,
    wallet: impl Wire2Api<RustOpaque<WalletInstance>> + UnwindSafe,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        ...
        move || {
            ...
            let api_only_witness_utxo = only_witness_utxo.wire2api();
            move |task_callback| Ok(get_psbt_input(api_wallet, api_utxo, api_only_witness_utxo))
        },
    )
}
