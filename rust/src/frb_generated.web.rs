    ...
    for flutter_rust_bridge::for_generated::wasm_bindgen::JsValue
{
    ...
    fn cst_decode(self) -> crate::api::error::BdkError {
        ...
        match self_.get(0).unchecked_into_f64() as _ {
            ...
            2 => crate::api::error::BdkError::VerifyTransaction(self_.get(1).cst_decode()),
            3 => crate::api::error::BdkError::Address(self_.get(1).cst_decode()),
            4 => crate::api::error::BdkError::Descriptor(self_.get(1).cst_decode()),
            5 => crate::api::error::BdkError::InvalidU32Bytes(self_.get(1).cst_decode()),
            6 => crate::api::error::BdkError::Generic(self_.get(1).cst_decode()),
            ...
            10 => crate::api::error::BdkError::OutputBelowDustLimit(self_.get(1).cst_decode()),
            11 => crate::api::error::BdkError::InsufficientFunds {
            ...
            18 => crate::api::error::BdkError::FeeRateTooLow {
                needed: self_.get(1).cst_decode(),
            },
            19 => crate::api::error::BdkError::FeeTooLow {
                needed: self_.get(1).cst_decode(),
            },
            20 => crate::api::error::BdkError::FeeRateUnavailable,
            21 => crate::api::error::BdkError::MissingKeyOrigin(self_.get(1).cst_decode()),
            22 => crate::api::error::BdkError::Key(self_.get(1).cst_decode()),
            23 => crate::api::error::BdkError::ChecksumMismatch,
            24 => crate::api::error::BdkError::SpendingPolicyRequired(self_.get(1).cst_decode()),
            25 => crate::api::error::BdkError::InvalidPolicyPathError(self_.get(1).cst_decode()),
            26 => crate::api::error::BdkError::Signer(self_.get(1).cst_decode()),
            27 => crate::api::error::BdkError::InvalidNetwork {
                requested: self_.get(1).cst_decode(),
                found: self_.get(2).cst_decode(),
            },
            28 => crate::api::error::BdkError::InvalidOutpoint(self_.get(1).cst_decode()),
            29 => crate::api::error::BdkError::Encode(self_.get(1).cst_decode()),
            30 => crate::api::error::BdkError::Miniscript(self_.get(1).cst_decode()),
            31 => crate::api::error::BdkError::MiniscriptPsbt(self_.get(1).cst_decode()),
            32 => crate::api::error::BdkError::Bip32(self_.get(1).cst_decode()),
            33 => crate::api::error::BdkError::Bip39(self_.get(1).cst_decode()),
            34 => crate::api::error::BdkError::Secp256k1(self_.get(1).cst_decode()),
            35 => crate::api::error::BdkError::Json(self_.get(1).cst_decode()),
            36 => crate::api::error::BdkError::Psbt(self_.get(1).cst_decode()),
            37 => crate::api::error::BdkError::PsbtParse(self_.get(1).cst_decode()),
            38 => crate::api::error::BdkError::MissingCachedScripts(
                self_.get(1).cst_decode(),
                self_.get(2).cst_decode(),
            ),
            39 => crate::api::error::BdkError::Electrum(self_.get(1).cst_decode()),
            40 => crate::api::error::BdkError::Esplora(self_.get(1).cst_decode()),
            41 => crate::api::error::BdkError::Sled(self_.get(1).cst_decode()),
            42 => crate::api::error::BdkError::Rpc(self_.get(1).cst_decode()),
            43 => crate::api::error::BdkError::Rusqlite(self_.get(1).cst_decode()),
            44 => crate::api::error::BdkError::InvalidInput(self_.get(1).cst_decode()),
            45 => crate::api::error::BdkError::InvalidLockTime(self_.get(1).cst_decode()),
            46 => crate::api::error::BdkError::InvalidTransaction(self_.get(1).cst_decode()),
            _ => unreachable!(),
        }
    }
}
