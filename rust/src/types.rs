...
//         if let bdk::bitcoin::Network::Signet = network {
//             Network::Signet
//         } else if let bdk::bitcoin::Network::Testnet = network {
//             Network::Testnet
//         } else if let bdk::bitcoin::Network::Regtest = network {
//             Network::Regtest
//         } else {
//             Network::Bitcoin
//         }
...
//             .map(|a| Address { inner: a.assume_checked() })
...
//             },
//
//             bdk::bitcoin::address::Payload::WitnessProgram(witness_program) => Payload::WitnessProgram {
//                 version: witness_program.version().into(),
...
// }
// impl Script {
//     pub fn new(raw_output_script: Vec<u8>) -> Script {
//         Script{inner: bdk::bitcoin::blockdata::script::ScriptBuf::from(raw_output_script).to_bytes()}
//     }
// }
//
// impl From<Script> for bdk::bitcoin::blockdata::script::ScriptBuf {
//     fn from(value: Script) -> Self {
//         bdk::bitcoin::blockdata::script::ScriptBuf::from(value.inner)
//     }
// }
// impl From<bdk::bitcoin::blockdata::script::ScriptBuf> for Script {
//     fn from(value: bdk::bitcoin::blockdata::script::ScriptBuf) -> Self {
//         Script {
