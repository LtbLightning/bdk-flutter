...
/*
==================================================================================================
 EXTERNAL PUBLIC FUNCTIONS FOR BDK FLUTTER PLUGIN
==================================================================================================
*/
#[repr(C)]
...
pub fn generate_extended_key(
    ...
    let network = self::config_network(network.as_str());
...
fn restore_extended_key(
    ...
    let mnemonic_parse = Mnemonic::parse_in(Language::English, mnemonic.clone()).unwrap();
    let network = self::config_network(network.as_str());
...
pub fn create_descriptor(xprv: String) -> String {
    return "wpkh(".to_owned() + &xprv + "/84'/1'/0'/0/*)";
}

pub fn create_change_descriptor(xprv: String) -> String {
    return "wpkh(".to_owned() + &xprv + "/84'/1'/0'/1/*)";
}
