...
class BdkWallet {
  ...
  Future<Balance> getBalance({dynamic hint}) =>
      BdkCore.instance.api.bdkWalletGetBalance(
        that: this,
        hint: hint,
      );
  ...
  Future<bool> isMine({required BdkScriptBuf script, dynamic hint}) =>
      BdkCore.instance.api.bdkWalletIsMine(
        that: this,
        script: script,
        hint: hint,
      );
  ...
  Future<List<LocalUtxo>> listUnspent({dynamic hint}) =>
      BdkCore.instance.api.bdkWalletListUnspent(
        that: this,
        hint: hint,
      );
  ...
  Future<Network> network({dynamic hint}) =>
      BdkCore.instance.api.bdkWalletNetwork(
        that: this,
        hint: hint,
      );
  ...
  static Future<void> sync(
          ...
          dynamic hint}) =>
      BdkCore.instance.api.bdkWalletSync(
        ptr: ptr,
