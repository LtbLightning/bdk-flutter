...
class BdkPsbt {
  ...
  static Future<BdkPsbt> combine(
      ...
      BdkCore.instance.api.bdkPsbtCombine(
        ptr: ptr,
        other: other,
        hint: hint,
      );
  ...
  static Future<BdkTransaction> extractTx(
      ...
      BdkCore.instance.api.bdkPsbtExtractTx(
        ptr: ptr,
        hint: hint,
      );
  ...
  Future<int?> feeAmount({dynamic hint}) =>
      BdkCore.instance.api.bdkPsbtFeeAmount(
        that: this,
        hint: hint,
      );
  ...
  Future<FeeRate?> feeRate({dynamic hint}) =>
      BdkCore.instance.api.bdkPsbtFeeRate(
        that: this,
        hint: hint,
      );

  static Future<BdkPsbt> fromStr({required String psbtBase64, dynamic hint}) =>
      BdkCore.instance.api.bdkPsbtFromStr(
  ...
  static Future<BdkPsbt> fromUnsignedTx(
      ...
      BdkCore.instance.api.bdkPsbtFromUnsignedTx(
        tx: tx,
        hint: hint,
      );
  ...
  Future<String> jsonSerialize({dynamic hint}) =>
      BdkCore.instance.api.bdkPsbtJsonSerialize(
        that: this,
        hint: hint,
      );

  Future<String> serialize({dynamic hint}) =>
      BdkCore.instance.api.bdkPsbtSerialize(
        that: this,
        hint: hint,
      );

  Future<String> txid({dynamic hint}) => BdkCore.instance.api.bdkPsbtTxid(
        that: this,
        hint: hint,
      );

  Future<BdkPsbt> updateInput({required Input input, dynamic hint}) =>
      BdkCore.instance.api.bdkPsbtUpdateInput(
        that: this,
        input: input,
        hint: hint,
      );
