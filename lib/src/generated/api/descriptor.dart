...
class FfiDescriptor {
  ...
  static Future<FfiDescriptor> newBip44(
  ...
  static Future<FfiDescriptor> newBip44Public(
  ...
  static Future<FfiDescriptor> newBip49(
          {required FfiDescriptorSecretKey secretKey,
          required KeychainKind keychainKind,
          required Network network}) =>
  ...
  static Future<FfiDescriptor> newBip49Public(
          {required FfiDescriptorPublicKey publicKey,
          required String fingerprint,
          required KeychainKind keychainKind,
          required Network network}) =>
  ...
  static Future<FfiDescriptor> newBip84(
          {required FfiDescriptorSecretKey secretKey,
          required KeychainKind keychainKind,
          required Network network}) =>
  ...
  static Future<FfiDescriptor> newBip84Public(
          {required FfiDescriptorPublicKey publicKey,
          required String fingerprint,
          required KeychainKind keychainKind,
          required Network network}) =>
  ...
  static Future<FfiDescriptor> newBip86(
          {required FfiDescriptorSecretKey secretKey,
          required KeychainKind keychainKind,
          required Network network}) =>
  ...
  static Future<FfiDescriptor> newBip86Public(
          {required FfiDescriptorPublicKey publicKey,
          required String fingerprint,
          required KeychainKind keychainKind,
          required Network network}) =>
