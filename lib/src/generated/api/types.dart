...
// These function are ignored because they are on traits that is not defined in current crate (put an empty `#[frb]` on it to unignore): `assert_receiver_is_total_eq`, `assert_receiver_is_total_eq`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `cmp`, `cmp`, `eq`, `eq`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `hash`, `partial_cmp`, `partial_cmp`
...
class FfiPolicy {
  ...
  String asString() => core.instance.api.crateApiTypesFfiPolicyAsString(
        that: this,
      );

  Satisfaction contribution() =>
      core.instance.api.crateApiTypesFfiPolicyContribution(
        that: this,
      );
  ...
  SatisfiableItem item() => core.instance.api.crateApiTypesFfiPolicyItem(
        that: this,
      );

  bool requiresPath() => core.instance.api.crateApiTypesFfiPolicyRequiresPath(
        that: this,
      );

  Satisfaction satisfaction() =>
      core.instance.api.crateApiTypesFfiPolicySatisfaction(
        that: this,
      );
