...
// These function are ignored because they are on traits that is not defined in current crate (put an empty `#[frb]` on it to unignore): `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`, `from`
...
sealed class CreateTxError with _$CreateTxError implements FrbException {
  ...
  const factory CreateTxError.transactionNotFound({
    required String txid,
  }) = CreateTxError_TransactionNotFound;
  const factory CreateTxError.transactionConfirmed({
    required String txid,
  }) = CreateTxError_TransactionConfirmed;
  const factory CreateTxError.irreplaceableTransaction({
    required String txid,
  }) = CreateTxError_IrreplaceableTransaction;
  const factory CreateTxError.feeRateUnavailable() =
      CreateTxError_FeeRateUnavailable;
...
@freezed
sealed class StringParseError with _$StringParseError implements FrbException {
  const StringParseError._();

  const factory StringParseError.generic({
    required String errorMessage,
  }) = StringParseError_Generic;
}
