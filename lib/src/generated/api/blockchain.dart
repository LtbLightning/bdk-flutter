...
class BlockchainBase {
  ...
  Future<String> broadcast(
          {required TransactionBase transaction, dynamic hint}) =>
      BdkCore.instance.api.blockchainBaseBroadcast(
        that: this,
        transaction: transaction,
      );

  Future<FeeRate> estimateFee({required int target, dynamic hint}) =>
      BdkCore.instance.api.blockchainBaseEstimateFee(
        that: this,
        target: target,
      );

  Future<String> getBlockHash({required int height, dynamic hint}) =>
      BdkCore.instance.api.blockchainBaseGetBlockHash(
        that: this,
        height: height,
      );

  Future<int> getHeight({dynamic hint}) =>
      BdkCore.instance.api.blockchainBaseGetHeight(
        that: this,
      );

  static Future<BlockchainBase> newBlockchainBase(
          {required BlockchainConfig blockchainConfig, dynamic hint}) =>
      BdkCore.instance.api
          .blockchainBaseNew(blockchainConfig: blockchainConfig, hint: hint);
