...
class BdkBlockchain {
  ...
  Future<FeeRate> estimateFee({required int target, dynamic hint}) =>
      BdkCore.instance.api.bdkBlockchainEstimateFee(
        that: this,
        target: target,
        hint: hint,
      );
  ...
  Future<String> getBlockHash({required int height, dynamic hint}) =>
      BdkCore.instance.api.bdkBlockchainGetBlockHash(
        that: this,
        height: height,
        hint: hint,
      );
  ...
  Future<int> getHeight({dynamic hint}) =>
      BdkCore.instance.api.bdkBlockchainGetHeight(
        that: this,
        hint: hint,
      );
  ...
  static Future<BdkBlockchain> newInstance(
      ...
      BdkCore.instance.api.bdkBlockchainNew(
