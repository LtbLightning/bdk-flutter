...
class FfiDescriptorPublicKey {
  ...
  static FfiDescriptorPublicKey derive(
  ...
  static FfiDescriptorPublicKey extend(
          {required FfiDescriptorPublicKey opaque,
          required FfiDerivationPath path}) =>
      core.instance.api
...
class FfiDescriptorSecretKey {
  ...
  static FfiDescriptorSecretKey derive(
          {required FfiDescriptorSecretKey opaque,
          required FfiDerivationPath path}) =>
      core.instance.api
          .crateApiKeyFfiDescriptorSecretKeyDerive(opaque: opaque, path: path);

  static FfiDescriptorSecretKey extend(
          {required FfiDescriptorSecretKey opaque,
          required FfiDerivationPath path}) =>
      core.instance.api
...
class FfiMnemonic {
  ...
  static FfiMnemonic fromEntropy({required List<int> entropy}) =>
      core.instance.api.crateApiKeyFfiMnemonicFromEntropy(entropy: entropy);

  /// Parse a Mnemonic with given string
  static FfiMnemonic fromString({required String mnemonic}) =>
