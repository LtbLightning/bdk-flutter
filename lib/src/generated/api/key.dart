...
// Rust type: RustOpaqueNom<flutter_rust_bridge::for_generated::rust_async::RwLock<Arc < bitcoin :: bip32 :: DerivationPath >>>
@sealed
class ArcBitcoinBip32DerivationPath extends RustOpaque {
  ArcBitcoinBip32DerivationPath.dcoDecode(List<dynamic> wire)
      : super.dcoDecode(wire, _kStaticData);

  ArcBitcoinBip32DerivationPath.sseDecode(int ptr, int externalSizeOnNative)
      : super.sseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: BdkCore.instance.api
        .rust_arc_increment_strong_count_ArcBitcoinBip32DerivationPath,
    rustArcDecrementStrongCount: BdkCore.instance.api
        .rust_arc_decrement_strong_count_ArcBitcoinBip32DerivationPath,
    rustArcDecrementStrongCountPtr: BdkCore.instance.api
        .rust_arc_decrement_strong_count_ArcBitcoinBip32DerivationPathPtr,
  );
}

// Rust type: RustOpaqueNom<flutter_rust_bridge::for_generated::rust_async::RwLock<Arc < keys :: bip39 :: Mnemonic >>>
@sealed
class ArcKeysBip39Mnemonic extends RustOpaque {
  ArcKeysBip39Mnemonic.dcoDecode(List<dynamic> wire)
      : super.dcoDecode(wire, _kStaticData);

  ArcKeysBip39Mnemonic.sseDecode(int ptr, int externalSizeOnNative)
      : super.sseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: BdkCore
        .instance.api.rust_arc_increment_strong_count_ArcKeysBip39Mnemonic,
    rustArcDecrementStrongCount: BdkCore
        .instance.api.rust_arc_decrement_strong_count_ArcKeysBip39Mnemonic,
    rustArcDecrementStrongCountPtr: BdkCore
        .instance.api.rust_arc_decrement_strong_count_ArcKeysBip39MnemonicPtr,
  );
}

class DerivationPathBase {
  final ArcBitcoinBip32DerivationPath ptr;
...
class DescriptorPublicKeyBase {
  final ArcKeysDescriptorPublicKey ptr;
...
class DescriptorSecretKeyBase {
  final ArcKeysDescriptorSecretKey ptr;
...
class MnemonicBase {
  final ArcKeysBip39Mnemonic ptr;
  ...
  static Future<MnemonicBase> newMnemonicBase(
