...
class BdkDerivationPath {
  ...
  static Future<BdkDerivationPath> fromString(
      ...
      BdkCore.instance.api.bdkDerivationPathFromString(
        path: path,
        hint: hint,
      );
...
class BdkDescriptorPublicKey {
  ...
  Future<String> asString({dynamic hint}) =>
      BdkCore.instance.api.bdkDescriptorPublicKeyAsString(
        that: this,
        hint: hint,
      );
  ...
  static Future<BdkDescriptorPublicKey> derive(
          ...
          dynamic hint}) =>
      BdkCore.instance.api.bdkDescriptorPublicKeyDerive(
        ptr: ptr,
        path: path,
        hint: hint,
      );
  ...
  static Future<BdkDescriptorPublicKey> extend(
          ...
          required BdkDerivationPath path,
          dynamic hint}) =>
      BdkCore.instance.api.bdkDescriptorPublicKeyExtend(
        ptr: ptr,
        path: path,
        hint: hint,
      );
  ...
  static Future<BdkDescriptorPublicKey> fromString(
      ...
      BdkCore.instance.api.bdkDescriptorPublicKeyFromString(
        publicKey: publicKey,
        hint: hint,
      );
...
class BdkDescriptorSecretKey {
  ...
  static Future<BdkDescriptorPublicKey> asPublic(
      ...
      BdkCore.instance.api.bdkDescriptorSecretKeyAsPublic(
        ptr: ptr,
        hint: hint,
      );

  Future<String> asString({dynamic hint}) =>
      BdkCore.instance.api.bdkDescriptorSecretKeyAsString(
        that: this,
        hint: hint,
      );
  ...
  static Future<BdkDescriptorSecretKey> derive(
          ...
          required BdkDerivationPath path,
          dynamic hint}) =>
      BdkCore.instance.api.bdkDescriptorSecretKeyDerive(
        ptr: ptr,
        path: path,
        hint: hint,
      );
  ...
  static Future<BdkDescriptorSecretKey> extend(
          ...
          required BdkDerivationPath path,
          dynamic hint}) =>
      BdkCore.instance.api.bdkDescriptorSecretKeyExtend(
        ptr: ptr,
        path: path,
        hint: hint,
      );
  ...
  static Future<BdkDescriptorSecretKey> fromString(
      ...
      BdkCore.instance.api.bdkDescriptorSecretKeyFromString(
        secretKey: secretKey,
        hint: hint,
      );
  ...
  Future<Uint8List> secretBytes({dynamic hint}) =>
      BdkCore.instance.api.bdkDescriptorSecretKeySecretBytes(
        that: this,
        hint: hint,
      );
...
class BdkMnemonic {
  ...
  Future<String> asString({dynamic hint}) =>
      BdkCore.instance.api.bdkMnemonicAsString(
        that: this,
        hint: hint,
      );
  ...
  static Future<BdkMnemonic> fromEntropy(
      ...
      BdkCore.instance.api.bdkMnemonicFromEntropy(
        entropy: entropy,
        hint: hint,
      );
  ...
  static Future<BdkMnemonic> fromString(
      ...
      BdkCore.instance.api.bdkMnemonicFromString(
        mnemonic: mnemonic,
        hint: hint,
      );
  ...
  static Future<BdkMnemonic> newInstance(
      ...
      BdkCore.instance.api.bdkMnemonicNew(
        wordCount: wordCount,
        hint: hint,
      );
