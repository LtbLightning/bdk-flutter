...
class RustImpl implements Rust {
  ...
  Future<Uint8List> serializeTransaction(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_serialize_transaction(port_, arg0),
  ...
  Future<double> asSatPerVbStaticMethodFeeRate(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_as_sat_per_vb__static_method__FeeRate(port_, arg0),
  ...
  DropFnType get dropOpaqueTransaction =>
      _platform.inner.drop_opaque_Transaction;
  ShareFnType get shareOpaqueTransaction =>
      _platform.inner.share_opaque_Transaction;
  OpaqueTypeFinalizer get TransactionFinalizer =>
      _platform.TransactionFinalizer;
...
// Section: finalizer
  ...
  late final OpaqueTypeFinalizer _TransactionFinalizer =
      OpaqueTypeFinalizer(inner._drop_opaque_TransactionPtr);
...
// Section: api_fill_to_wire
  ...
  void _api_fill_to_wire_box_autoadd_fee_rate(
      FeeRate apiObj, ffi.Pointer<wire_FeeRate> wireObj) {
...
class RustWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_broadcastPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, wire_Transaction,
              wire_BlockchainInstance)>>('wire_broadcast');
  late final _wire_broadcast = _wire_broadcastPtr.asFunction<
      void Function(int, wire_Transaction, wire_BlockchainInstance)>();
  ...
  late final _wire_serialize_transactionPtr = _lookup<
          ffi.NativeFunction<ffi.Void Function(ffi.Int64, wire_Transaction)>>(
      'wire_serialize_transaction');
  late final _wire_serialize_transaction = _wire_serialize_transactionPtr
      .asFunction<void Function(int, wire_Transaction)>();
  ...
  late final _wire_as_sat_per_vb__static_method__FeeRatePtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Int64, ffi.Pointer<wire_FeeRate>)>>(
      'wire_as_sat_per_vb__static_method__FeeRate');
  late final _wire_as_sat_per_vb__static_method__FeeRate =
      _wire_as_sat_per_vb__static_method__FeeRatePtr
          .asFunction<void Function(int, ffi.Pointer<wire_FeeRate>)>();
  ...
  late final _new_TransactionPtr =
      _lookup<ffi.NativeFunction<wire_Transaction Function()>>(
          'new_Transaction');
  late final _new_Transaction =
      _new_TransactionPtr.asFunction<wire_Transaction Function()>();
  ...
  late final _new_box_autoadd_fee_rate_0Ptr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_FeeRate> Function()>>(
          'new_box_autoadd_fee_rate_0');
  late final _new_box_autoadd_fee_rate_0 = _new_box_autoadd_fee_rate_0Ptr
      .asFunction<ffi.Pointer<wire_FeeRate> Function()>();
  ...
  late final _drop_opaque_TransactionPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
          'drop_opaque_Transaction');
  late final _drop_opaque_Transaction = _drop_opaque_TransactionPtr
      .asFunction<void Function(ffi.Pointer<ffi.Void>)>();
  ...
  late final _share_opaque_TransactionPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Void> Function(
              ffi.Pointer<ffi.Void>)>>('share_opaque_Transaction');
  late final _share_opaque_Transaction = _share_opaque_TransactionPtr
      .asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>();
