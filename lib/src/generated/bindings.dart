...
var arg13 = _platform.api2wire_uint_8_list(data);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_tx_builder_finish(port_, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13),
            parseSuccessData: _wire2api_tx_builder_result,
            
        constMeta: kTxBuilderFinishConstMeta,
        argValues: [wallet, recipients, utxos, unspendable, manuallySelectedOnly, onlySpendChange, doNotSpendChange, feeRate, feeAbsolute, drainWallet, drainTo, enableRbf, nSequence, data],
        hint: hint,
        ...
        FlutterRustBridgeTaskConstMeta get kTxBuilderFinishConstMeta => const FlutterRustBridgeTaskConstMeta(
            ...
            argNames: ["wallet", "recipients", "utxos", "unspendable", "manuallySelectedOnly", "onlySpendChange", "doNotSpendChange", "feeRate", "feeAbsolute", "drainWallet", "drainTo", "enableRbf", "nSequence", "data"],
        );
...
Future<BdkDescriptor> newBip44Descriptor({ required KeyChainKind keyChainKind,required String secretKey,required Network network,dynamic hint }) {
            var arg0 = api2wire_key_chain_kind(keyChainKind);
...
TransactionDetails _wire2api_transaction_details(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return TransactionDetails(txid: _wire2api_String(arr[0]),
...
TxBuilderResult _wire2api_tx_builder_result(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return TxBuilderResult(psbt: _wire2api_String(arr[0]),
...
@protected
                    int api2wire_key_chain_kind(KeyChainKind raw) {
                        return api2wire_i32(raw.index);
                    }
