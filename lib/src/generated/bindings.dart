...
class RustImpl implements Rust {
  ...
  Future<Transaction> newTransaction({required Uint8List tx, dynamic hint}) {
  ...
  Future<Uint8List> serializeTransaction({required Transaction tx, dynamic hint}) {
    var arg0 = _platform.api2wire_Transaction(tx);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_serialize_transaction(port_, arg0),
      parseSuccessData: _wire2api_uint_8_list,
      constMeta: kSerializeTransactionConstMeta,
      argValues: [tx],
      hint: hint,
    ));
  }

  FlutterRustBridgeTaskConstMeta get kSerializeTransactionConstMeta => const FlutterRustBridgeTaskConstMeta(
        debugName: "serialize_transaction",
        argNames: ["tx"],
      );
  ...
  Future<Transaction> extractTx({required String psbtStr, dynamic hint}) {
    var arg0 = _platform.api2wire_String(psbtStr);
    return _platform.executeNormal(FlutterRustBridgeTask(
  ...
  Future<double> asSatPerVbStaticMethodFeeRate({required FeeRate feeRate, dynamic hint}) {
    var arg0 = _platform.api2wire_box_autoadd_fee_rate(feeRate);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_as_sat_per_vb__static_method__FeeRate(port_, arg0),
      parseSuccessData: _wire2api_f32,
      constMeta: kAsSatPerVbStaticMethodFeeRateConstMeta,
      argValues: [feeRate],
      hint: hint,
    ));
  }

  FlutterRustBridgeTaskConstMeta get kAsSatPerVbStaticMethodFeeRateConstMeta => const FlutterRustBridgeTaskConstMeta(
        debugName: "as_sat_per_vb__static_method__FeeRate",
        argNames: ["feeRate"],
      );
  ...
  DropFnType get dropOpaqueTransaction => _platform.inner.drop_opaque_Transaction;
  ShareFnType get shareOpaqueTransaction => _platform.inner.share_opaque_Transaction;
  OpaqueTypeFinalizer get TransactionFinalizer => _platform.TransactionFinalizer;
...
// Section: wire2api
  ...
  Transaction _wire2api_Transaction(dynamic raw) {
    return Transaction.fromRaw(raw[0], raw[1], this);
  }
  ...
  FeeRate _wire2api_box_autoadd_fee_rate(dynamic raw) {
    return _wire2api_fee_rate(raw);
  }
  ...
  FeeRate _wire2api_fee_rate(dynamic raw) {
    final arr = raw as List<dynamic>;
  ...
  FeeRate? _wire2api_opt_box_autoadd_fee_rate(dynamic raw) {
    return raw == null ? null : _wire2api_box_autoadd_fee_rate(raw);
  }
...
// Section: api2wire
  ...
  @protected
  wire_Transaction api2wire_Transaction(Transaction raw) {
    final ptr = inner.new_Transaction();
    _api_fill_to_wire_Transaction(raw, ptr);
    return ptr;
  }
  ...
  @protected
  ffi.Pointer<wire_FeeRate> api2wire_box_autoadd_fee_rate(FeeRate raw) {
    final ptr = inner.new_box_autoadd_fee_rate_0();
    _api_fill_to_wire_fee_rate(raw, ptr.ref);
    return ptr;
  }
...
// Section: finalizer
  ...
  late final OpaqueTypeFinalizer _TransactionFinalizer = OpaqueTypeFinalizer(inner._drop_opaque_TransactionPtr);
  OpaqueTypeFinalizer get TransactionFinalizer => _TransactionFinalizer;
...
// Section: api_fill_to_wire
  ...
  void _api_fill_to_wire_Transaction(Transaction apiObj, wire_Transaction wireObj) {
    wireObj.ptr = apiObj.shareOrMove();
  }
  ...
  void _api_fill_to_wire_box_autoadd_fee_rate(FeeRate apiObj, ffi.Pointer<wire_FeeRate> wireObj) {
    _api_fill_to_wire_fee_rate(apiObj, wireObj.ref);
  }
  ...
  void _api_fill_to_wire_fee_rate(FeeRate apiObj, wire_FeeRate wireObj) {
    wireObj.field0 = api2wire_f32(apiObj.field0);
  }
...
class RustWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_broadcastPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, wire_Transaction, wire_BlockchainInstance)>>(
          'wire_broadcast');
  late final _wire_broadcast =
      _wire_broadcastPtr.asFunction<void Function(int, wire_Transaction, wire_BlockchainInstance)>();
  ...
  void wire_serialize_transaction(
    int port_,
    wire_Transaction tx,
  ) {
    return _wire_serialize_transaction(
      port_,
      tx,
    );
  }

  late final _wire_serialize_transactionPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, wire_Transaction)>>('wire_serialize_transaction');
  late final _wire_serialize_transaction =
      _wire_serialize_transactionPtr.asFunction<void Function(int, wire_Transaction)>();
  ...
  void wire_as_sat_per_vb__static_method__FeeRate(
    int port_,
    ffi.Pointer<wire_FeeRate> fee_rate,
  ) {
    return _wire_as_sat_per_vb__static_method__FeeRate(
      port_,
      fee_rate,
    );
  }

  late final _wire_as_sat_per_vb__static_method__FeeRatePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Pointer<wire_FeeRate>)>>(
          'wire_as_sat_per_vb__static_method__FeeRate');
  late final _wire_as_sat_per_vb__static_method__FeeRate =
      _wire_as_sat_per_vb__static_method__FeeRatePtr.asFunction<void Function(int, ffi.Pointer<wire_FeeRate>)>();
  ...
  wire_Transaction new_Transaction() {
    return _new_Transaction();
  }

  late final _new_TransactionPtr = _lookup<ffi.NativeFunction<wire_Transaction Function()>>('new_Transaction');
  late final _new_Transaction = _new_TransactionPtr.asFunction<wire_Transaction Function()>();
  ...
  ffi.Pointer<wire_FeeRate> new_box_autoadd_fee_rate_0() {
    return _new_box_autoadd_fee_rate_0();
  }

  late final _new_box_autoadd_fee_rate_0Ptr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_FeeRate> Function()>>('new_box_autoadd_fee_rate_0');
  late final _new_box_autoadd_fee_rate_0 =
      _new_box_autoadd_fee_rate_0Ptr.asFunction<ffi.Pointer<wire_FeeRate> Function()>();
  ...
  void drop_opaque_Transaction(
    ffi.Pointer<ffi.Void> ptr,
  ) {
    return _drop_opaque_Transaction(
      ptr,
    );
  }

  late final _drop_opaque_TransactionPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>('drop_opaque_Transaction');
  late final _drop_opaque_Transaction = _drop_opaque_TransactionPtr.asFunction<void Function(ffi.Pointer<ffi.Void>)>();

  ffi.Pointer<ffi.Void> share_opaque_Transaction(
    ffi.Pointer<ffi.Void> ptr,
  ) {
    return _share_opaque_Transaction(
      ptr,
    );
  }

  late final _share_opaque_TransactionPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>('share_opaque_Transaction');
  late final _share_opaque_Transaction =
      _share_opaque_TransactionPtr.asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>();
...
class wire_FeeRate extends ffi.Struct {
  @ffi.Float()
