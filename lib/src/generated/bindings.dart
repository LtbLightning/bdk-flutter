...
class RustImpl implements Rust {
  ...
  Future<double> asSatPerVbMethodFeeRate({required FeeRate that, dynamic hint}) {
    var arg0 = _platform.api2wire_box_autoadd_fee_rate(that);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_as_sat_per_vb__method__FeeRate(port_, arg0),
  ...
  FlutterRustBridgeTaskConstMeta get kAsSatPerVbMethodFeeRateConstMeta => const FlutterRustBridgeTaskConstMeta(
...
class RustWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_as_sat_per_vb__method__FeeRatePtr =
  ...
  late final _wire_as_sat_per_vb__method__FeeRate =
      _wire_as_sat_per_vb__method__FeeRatePtr.asFunction<void Function(int, ffi.Pointer<wire_FeeRate>)>();
