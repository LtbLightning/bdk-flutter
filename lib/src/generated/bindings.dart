...
// Section: wire2api
  ...
  Script _wire2api_script(dynamic raw) {
    ...
    return Script(
      inner: _wire2api_uint_8_list(arr[0]),
    );
  }
...
// Section: api_fill_to_wire
  ...
  void _api_fill_to_wire_script(Script apiObj, wire_Script wireObj) {
    wireObj.inner = api2wire_uint_8_list(apiObj.inner);
  }
...
class RustBdkFfiWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_new_bip86_descriptor__static_method__ApiPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Int32, ffi.Pointer<wire_uint_8_list>, ffi.Int32)>>(
          'wire_new_bip86_descriptor__static_method__Api');
  late final _wire_new_bip86_descriptor__static_method__Api = _wire_new_bip86_descriptor__static_method__ApiPtr
      .asFunction<void Function(int, int, ffi.Pointer<wire_uint_8_list>, int)>();
  ...
  late final _wire_new_bip86_public__static_method__ApiPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Int32, ffi.Pointer<wire_uint_8_list>, ffi.Int32,
              ffi.Pointer<wire_uint_8_list>)>>('wire_new_bip86_public__static_method__Api');
  late final _wire_new_bip86_public__static_method__Api = _wire_new_bip86_public__static_method__ApiPtr
      .asFunction<void Function(int, int, ffi.Pointer<wire_uint_8_list>, int, ffi.Pointer<wire_uint_8_list>)>();
