...
class RustImpl implements Rust {
  ...
  Future<BdkTxBuilderResult> txBuilderFinish(
    ...
    var arg6 = onlySpendChange;
    var arg7 = onlyWitnessUtxo;
    var arg8 = doNotSpendChange;
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_tx_builder_finish(
          port_, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15),
  ...
  Future<int> maxSatisfactionWeight({required BdkDescriptor descriptor, dynamic hint}) {
    var arg0 = _platform.api2wire_BdkDescriptor(descriptor);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_max_satisfaction_weight(port_, arg0),
      parseSuccessData: _wire2api_usize,
      constMeta: kMaxSatisfactionWeightConstMeta,
      argValues: [descriptor],
      hint: hint,
    ));
  }

  FlutterRustBridgeTaskConstMeta get kMaxSatisfactionWeightConstMeta => const FlutterRustBridgeTaskConstMeta(
        debugName: "max_satisfaction_weight",
        argNames: ["descriptor"],
      );
  ...
  Future<String?> sign(
      {required WalletInstance wallet, required String psbtStr, required bool trustWitnessUtxo, dynamic hint}) {
    var arg0 = _platform.api2wire_WalletInstance(wallet);
    var arg1 = _platform.api2wire_String(psbtStr);
    var arg2 = trustWitnessUtxo;
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_sign(port_, arg0, arg1, arg2),
      parseSuccessData: _wire2api_opt_String,
      constMeta: kSignConstMeta,
      argValues: [wallet, psbtStr, trustWitnessUtxo],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kSignConstMeta => const FlutterRustBridgeTaskConstMeta(
        debugName: "sign",
        argNames: ["wallet", "psbtStr", "trustWitnessUtxo"],
      );
  ...
  Future<BdkDescriptor> getDescriptorForKeychain(
      {required WalletInstance wallet, required KeychainKind keychain, dynamic hint}) {
    var arg0 = _platform.api2wire_WalletInstance(wallet);
    var arg1 = api2wire_keychain_kind(keychain);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_get_descriptor_for_keychain(port_, arg0, arg1),
      parseSuccessData: _wire2api_BdkDescriptor,
      constMeta: kGetDescriptorForKeychainConstMeta,
      argValues: [wallet, keychain],
      hint: hint,
    ));
  }

  FlutterRustBridgeTaskConstMeta get kGetDescriptorForKeychainConstMeta => const FlutterRustBridgeTaskConstMeta(
        debugName: "get_descriptor_for_keychain",
        argNames: ["wallet", "keychain"],
      );

  Future<String> getPsbtInput(
      {required WalletInstance wallet, required LocalUtxo utxo, required bool onlyWitnessUtxo, dynamic hint}) {
    var arg0 = _platform.api2wire_WalletInstance(wallet);
    var arg1 = _platform.api2wire_box_autoadd_local_utxo(utxo);
    var arg2 = onlyWitnessUtxo;
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_get_psbt_input(port_, arg0, arg1, arg2),
      parseSuccessData: _wire2api_String,
      constMeta: kGetPsbtInputConstMeta,
      argValues: [wallet, utxo, onlyWitnessUtxo],
      hint: hint,
    ));
  }

  FlutterRustBridgeTaskConstMeta get kGetPsbtInputConstMeta => const FlutterRustBridgeTaskConstMeta(
        debugName: "get_psbt_input",
...
// Section: api_fill_to_wire
  ...
  void _api_fill_to_wire_foreign_utxo(ForeignUtxo apiObj, wire_ForeignUtxo wireObj) {
    ...
    wireObj.psbt_input = api2wire_String(apiObj.psbtInput);
...
class RustWire implements FlutterRustBridgeWireBase {
  ...
  void wire_max_satisfaction_weight(
    int port_,
    wire_BdkDescriptor descriptor,
  ) {
    return _wire_max_satisfaction_weight(
      port_,
      descriptor,
    );
  }

  late final _wire_max_satisfaction_weightPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, wire_BdkDescriptor)>>('wire_max_satisfaction_weight');
  late final _wire_max_satisfaction_weight =
      _wire_max_satisfaction_weightPtr.asFunction<void Function(int, wire_BdkDescriptor)>();
  ...
  late final _wire_get_descriptor_for_keychainPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, wire_WalletInstance, ffi.Int32)>>(
          'wire_get_descriptor_for_keychain');
  late final _wire_get_descriptor_for_keychain =
      _wire_get_descriptor_for_keychainPtr.asFunction<void Function(int, wire_WalletInstance, int)>();

  void wire_get_psbt_input(
    int port_,
    wire_WalletInstance wallet,
    ffi.Pointer<wire_LocalUtxo> utxo,
    bool only_witness_utxo,
  ) {
    return _wire_get_psbt_input(
      port_,
      wallet,
      utxo,
      only_witness_utxo,
  ...
  late final _wire_get_psbt_inputPtr = _lookup<
          ffi.NativeFunction<ffi.Void Function(ffi.Int64, wire_WalletInstance, ffi.Pointer<wire_LocalUtxo>, ffi.Bool)>>(
      'wire_get_psbt_input');
...
class wire_ForeignUtxo extends ffi.Struct {
  ...
  external ffi.Pointer<wire_uint_8_list> psbt_input;

  @ffi.UintPtr()
  external int satisfaction_weight;
}
