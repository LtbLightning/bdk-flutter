...
class RustImpl implements Rust {
  ...
  Future<double> asSatPerVbMethodFeeRate(
      {required FeeRate that, dynamic hint}) {
    var arg0 = _platform.api2wire_box_autoadd_fee_rate(that);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_as_sat_per_vb__method__FeeRate(port_, arg0),
      parseSuccessData: _wire2api_f32,
      constMeta: kAsSatPerVbMethodFeeRateConstMeta,
      argValues: [that],
      hint: hint,
    ));
  }

  FlutterRustBridgeTaskConstMeta get kAsSatPerVbMethodFeeRateConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "as_sat_per_vb__method__FeeRate",
        argNames: ["that"],
      );
...
class RustWire implements FlutterRustBridgeWireBase {
  ...
  void wire_as_sat_per_vb__method__FeeRate(
    int port_,
    ffi.Pointer<wire_FeeRate> that,
  ) {
    return _wire_as_sat_per_vb__method__FeeRate(
      port_,
      that,
    );
  }

  late final _wire_as_sat_per_vb__method__FeeRatePtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Int64, ffi.Pointer<wire_FeeRate>)>>(
      'wire_as_sat_per_vb__method__FeeRate');
  late final _wire_as_sat_per_vb__method__FeeRate =
      _wire_as_sat_per_vb__method__FeeRatePtr
