...
Future<String> getBlockchainHash({ required int blockchainHeight,required BlockchainInstance blockchain,dynamic hint });
...
Future<TxBuilderResult> txBuilderFinish({ required WalletInstance wallet,required List<ScriptAmount> recipients,required List<OutPoint> utxos,required List<OutPoint> unspendable,required bool manuallySelectedOnly,required bool onlySpendChange,required bool doNotSpendChange,double? feeRate,int? feeAbsolute,required bool drainWallet,String? drainTo,required bool enableRbf,int? nSequence,required Uint8List data,dynamic hint });

FlutterRustBridgeTaskConstMeta get kTxBuilderFinishConstMeta;

Future<String> bumpFeeTxBuilderFinish({ required String txid,required double feeRate,String? allowShrinking,required WalletInstance wallet,required bool enableRbf,int? nSequence,dynamic hint });
...
Future<BdkDescriptor> newBip44Descriptor({ required KeyChainKind keyChainKind,required String secretKey,required Network network,dynamic hint });

FlutterRustBridgeTaskConstMeta get kNewBip44DescriptorConstMeta;

Future<BdkDescriptor> newBip44Public({ required KeyChainKind keyChainKind,required String publicKey,required Network network,required String fingerprint,dynamic hint });

FlutterRustBridgeTaskConstMeta get kNewBip44PublicConstMeta;

Future<BdkDescriptor> newBip49Descriptor({ required KeyChainKind keyChainKind,required String secretKey,required Network network,dynamic hint });

FlutterRustBridgeTaskConstMeta get kNewBip49DescriptorConstMeta;

Future<BdkDescriptor> newBip49Public({ required KeyChainKind keyChainKind,required String publicKey,required Network network,required String fingerprint,dynamic hint });

FlutterRustBridgeTaskConstMeta get kNewBip49PublicConstMeta;

Future<BdkDescriptor> newBip84Descriptor({ required KeyChainKind keyChainKind,required String secretKey,required Network network,dynamic hint });

FlutterRustBridgeTaskConstMeta get kNewBip84DescriptorConstMeta;

Future<BdkDescriptor> newBip84Public({ required KeyChainKind keyChainKind,required String publicKey,required Network network,required String fingerprint,dynamic hint });
...
Future<String> createDescriptorSecret({ required Network network,required String mnemonic,String? password,dynamic hint });
...
Future<WalletInstance> walletInit({ required BdkDescriptor descriptor,BdkDescriptor? changeDescriptor,required Network network,required DatabaseConfig databaseConfig,dynamic hint });
...
Future<String?> sign({ required WalletInstance wallet,required String psbtStr,required bool isMultiSig,dynamic hint });
...
FlutterRustBridgeTaskConstMeta get kGenerateSeedFromEntropyConstMeta;
    ...
    OpaqueTypeFinalizer get WalletInstanceFinalizer;
        ...
        @sealed class BdkDescriptor extends FrbOpaque {
                final Rust bridge;
...
@sealed class BlockchainInstance extends FrbOpaque {
                final Rust bridge;
...
@sealed class WalletInstance extends FrbOpaque {
                final Rust bridge;
...
final String address;
                ...
                AddressInfo({required this.index,required this.address,});
...
final int total;
                ...
                Balance({required this.immature,required this.trustedPending,required this.untrustedPending,required this.confirmed,required this.spendable,required this.total,});
...
final int timestamp;
                ...
                BlockTime({required this.height,required this.timestamp,});
...
@freezed
                class BlockchainConfig with _$BlockchainConfig {
                    /// Electrum client
const factory BlockchainConfig.electrum({ required ElectrumConfig config, }) = BlockchainConfig_Electrum;
/// Esplora client
const factory BlockchainConfig.esplora({ required EsploraConfig config, }) = BlockchainConfig_Esplora;
/// Bitcoin Core RPC client
const factory BlockchainConfig.rpc({ required RpcConfig config, }) = BlockchainConfig_Rpc;
                }
...
final bool validateDomain;
                ...
                ElectrumConfig({required this.url,this.socks5,required this.retry,this.timeout,required this.stopGap,required this.validateDomain,});
...
final int? timeout;
                ...
                EsploraConfig({required this.baseUrl,this.proxy,this.concurrency,required this.stopGap,this.timeout,});
...
final bool isSpent;
                ...
                LocalUtxo({required this.outpoint,required this.txout,required this.isSpent,});
...
final RpcSyncParams? syncParams;
                ...
                RpcConfig({required this.url,this.authCookie,this.authUserPass,required this.network,required this.walletName,this.syncParams,});
...
final int pollRateSec;
                ...
                RpcSyncParams({required this.startScriptCount,required this.startTime,required this.forceStartTime,required this.pollRateSec,});
...
final String treeName;
                ...
                SledDbConfiguration({required this.path,required this.treeName,});
...
final String path;
                ...
                SqliteDbConfiguration({required this.path,});
...
final BlockTime? confirmationTime;
                ...
                TransactionDetails({required this.txid,required this.received,required this.sent,this.fee,this.confirmationTime,});
...
final TransactionDetails transactionDetails;
                ...
                TxBuilderResult({required this.psbt,required this.transactionDetails,});
...
final String address;
                ...
                TxOut({required this.value,required this.address,});
...
final String password;
                ...
                UserPass({required this.username,required this.password,});
