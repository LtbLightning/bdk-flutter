...
class core extends BaseEntrypoint<coreApi, coreApiImpl, coreWire> {
  ...
  @override
  int get rustContentHash => 1899599943;
...
abstract class coreApi extends BaseApi {
  ...
  FfiDescriptor crateApiDescriptorFfiDescriptorNewBip44(
      {required FfiDescriptorSecretKey secretKey,
      required KeychainKind keychainKind,
      required Network network});

  FfiDescriptor crateApiDescriptorFfiDescriptorNewBip44Public(
      {required FfiDescriptorPublicKey publicKey,
      required String fingerprint,
      required KeychainKind keychainKind,
      required Network network});

  FfiDescriptor crateApiDescriptorFfiDescriptorNewBip49(
      {required FfiDescriptorSecretKey secretKey,
      required KeychainKind keychainKind,
      required Network network});

  FfiDescriptor crateApiDescriptorFfiDescriptorNewBip49Public(
      {required FfiDescriptorPublicKey publicKey,
      required String fingerprint,
      required KeychainKind keychainKind,
      required Network network});

  FfiDescriptor crateApiDescriptorFfiDescriptorNewBip84(
      {required FfiDescriptorSecretKey secretKey,
      required KeychainKind keychainKind,
      required Network network});

  FfiDescriptor crateApiDescriptorFfiDescriptorNewBip84Public(
      {required FfiDescriptorPublicKey publicKey,
      required String fingerprint,
      required KeychainKind keychainKind,
      required Network network});

  FfiDescriptor crateApiDescriptorFfiDescriptorNewBip86(
      {required FfiDescriptorSecretKey secretKey,
      required KeychainKind keychainKind,
      required Network network});

  FfiDescriptor crateApiDescriptorFfiDescriptorNewBip86Public(
      {required FfiDescriptorPublicKey publicKey,
      required String fingerprint,
      required KeychainKind keychainKind,
      required Network network});
  ...
  FfiDescriptorPublicKey crateApiKeyFfiDescriptorPublicKeyDerive(
      {required FfiDescriptorPublicKey opaque,
      required FfiDerivationPath path});

  FfiDescriptorPublicKey crateApiKeyFfiDescriptorPublicKeyExtend(
      {required FfiDescriptorPublicKey opaque,
      required FfiDerivationPath path});
  ...
  FfiDescriptorSecretKey crateApiKeyFfiDescriptorSecretKeyDerive(
      {required FfiDescriptorSecretKey opaque,
      required FfiDerivationPath path});

  FfiDescriptorSecretKey crateApiKeyFfiDescriptorSecretKeyExtend(
      {required FfiDescriptorSecretKey opaque,
      required FfiDerivationPath path});
  ...
  FfiMnemonic crateApiKeyFfiMnemonicFromEntropy({required List<int> entropy});

  FfiMnemonic crateApiKeyFfiMnemonicFromString({required String mnemonic});
  ...
  String crateApiTypesFfiPolicyAsString({required FfiPolicy that});

  Satisfaction crateApiTypesFfiPolicyContribution({required FfiPolicy that});

  String crateApiTypesFfiPolicyId({required FfiPolicy that});

  SatisfiableItem crateApiTypesFfiPolicyItem({required FfiPolicy that});

  bool crateApiTypesFfiPolicyRequiresPath({required FfiPolicy that});

  Satisfaction crateApiTypesFfiPolicySatisfaction({required FfiPolicy that});
  ...
  bool crateApiWalletFfiWalletSign(
...
class coreApiImpl extends coreApiImplPlatform implements coreApi {
  ...
  FfiMnemonic crateApiKeyFfiMnemonicFromEntropy({required List<int> entropy}) {
    return handler.executeSync(SyncTask(
      callFfi: () {
        ...
        return wire.wire__crate__api__key__ffi_mnemonic_from_entropy(arg0);
      },
      codec: DcoCodec(
  ...
  FfiMnemonic crateApiKeyFfiMnemonicFromString({required String mnemonic}) {
    return handler.executeSync(SyncTask(
      callFfi: () {
        ...
        return wire.wire__crate__api__key__ffi_mnemonic_from_string(arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_ffi_mnemonic,
        decodeErrorData: dco_decode_bip_39_error,
  ...
  String crateApiTypesFfiPolicyAsString({required FfiPolicy that}) {
    return handler.executeSync(SyncTask(
      callFfi: () {
        ...
        return wire.wire__crate__api__types__ffi_policy_as_string(arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_String,
        decodeErrorData: dco_decode_string_parse_error,
      ),
      constMeta: kCrateApiTypesFfiPolicyAsStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTypesFfiPolicyAsStringConstMeta =>
      const TaskConstMeta(
        debugName: "ffi_policy_as_string",
        argNames: ["that"],
      );
  ...
  Satisfaction crateApiTypesFfiPolicyContribution({required FfiPolicy that}) {
    return handler.executeSync(SyncTask(
      callFfi: () {
        var arg0 = cst_encode_box_autoadd_ffi_policy(that);
        return wire.wire__crate__api__types__ffi_policy_contribution(arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_satisfaction,
        decodeErrorData: null,
      ),
      constMeta: kCrateApiTypesFfiPolicyContributionConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTypesFfiPolicyContributionConstMeta =>
      const TaskConstMeta(
        debugName: "ffi_policy_contribution",
        argNames: ["that"],
      );
  ...
  SatisfiableItem crateApiTypesFfiPolicyItem({required FfiPolicy that}) {
    return handler.executeSync(SyncTask(
      callFfi: () {
        var arg0 = cst_encode_box_autoadd_ffi_policy(that);
        return wire.wire__crate__api__types__ffi_policy_item(arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_satisfiable_item,
        decodeErrorData: null,
      ),
      constMeta: kCrateApiTypesFfiPolicyItemConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTypesFfiPolicyItemConstMeta => const TaskConstMeta(
        debugName: "ffi_policy_item",
        argNames: ["that"],
      );
  ...
  bool crateApiTypesFfiPolicyRequiresPath({required FfiPolicy that}) {
    return handler.executeSync(SyncTask(
      callFfi: () {
        var arg0 = cst_encode_box_autoadd_ffi_policy(that);
        return wire.wire__crate__api__types__ffi_policy_requires_path(arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_bool,
        decodeErrorData: null,
      ),
      constMeta: kCrateApiTypesFfiPolicyRequiresPathConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTypesFfiPolicyRequiresPathConstMeta =>
      const TaskConstMeta(
        debugName: "ffi_policy_requires_path",
        argNames: ["that"],
      );
  ...
  Satisfaction crateApiTypesFfiPolicySatisfaction({required FfiPolicy that}) {
    return handler.executeSync(SyncTask(
      callFfi: () {
        var arg0 = cst_encode_box_autoadd_ffi_policy(that);
        return wire.wire__crate__api__types__ffi_policy_satisfaction(arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_satisfaction,
        decodeErrorData: null,
      ),
      constMeta: kCrateApiTypesFfiPolicySatisfactionConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTypesFfiPolicySatisfactionConstMeta =>
      const TaskConstMeta(
        debugName: "ffi_policy_satisfaction",
        argNames: ["that"],
      );
  ...
  bool crateApiWalletFfiWalletSign(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        ...
        return wire.wire__crate__api__wallet__ffi_wallet_sign(arg0, arg1, arg2);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_bool,
  ...
  CreateTxError dco_decode_create_tx_error(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return CreateTxError_TransactionNotFound(
          txid: dco_decode_String(raw[1]),
        );
      case 1:
        return CreateTxError_TransactionConfirmed(
          txid: dco_decode_String(raw[1]),
        );
      case 2:
        return CreateTxError_IrreplaceableTransaction(
          txid: dco_decode_String(raw[1]),
        );
      case 3:
        return CreateTxError_FeeRateUnavailable();
      case 4:
  ...
  FfiUpdate dco_decode_ffi_update(dynamic raw) {
    ...
    if (arr.length != 1)
      throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return FfiUpdate(
      opaque: dco_decode_RustOpaque_bdk_walletUpdate(arr[0]),
    );
  }
  ...
  List<FfiPolicy> dco_decode_list_ffi_policy(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_ffi_policy).toList();
  }
    ...
    switch (raw[0]) {
      ...
      case 9:
        return SatisfiableItem_Thresh(
          items: dco_decode_list_ffi_policy(raw[1]),
          threshold: dco_decode_u_64(raw[2]),
        );
      default:
        throw Exception("unreachable");
  ...
  StringParseError dco_decode_string_parse_error(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return StringParseError_Generic(
          errorMessage: dco_decode_String(raw[1]),
        );
      default:
        throw Exception("unreachable");
  ...
  CreateTxError sse_decode_create_tx_error(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      case 0:
        ...
        return CreateTxError_TransactionNotFound(txid: var_txid);
      case 1:
        var var_txid = sse_decode_String(deserializer);
        return CreateTxError_TransactionConfirmed(txid: var_txid);
      case 2:
        var var_txid = sse_decode_String(deserializer);
        return CreateTxError_IrreplaceableTransaction(txid: var_txid);
      case 3:
        return CreateTxError_FeeRateUnavailable();
      case 4:
        var var_errorMessage = sse_decode_String(deserializer);
  ...
  FfiUpdate sse_decode_ffi_update(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_opaque = sse_decode_RustOpaque_bdk_walletUpdate(deserializer);
    return FfiUpdate(opaque: var_opaque);
  }
  ...
  List<FfiPolicy> sse_decode_list_ffi_policy(SseDeserializer deserializer) {
    ...
    var ans_ = <FfiPolicy>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_ffi_policy(deserializer));
    }
    return ans_;
  }
  ...
  SatisfiableItem sse_decode_satisfiable_item(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      ...
      case 9:
        var var_items = sse_decode_list_ffi_policy(deserializer);
        var var_threshold = sse_decode_u_64(deserializer);
        return SatisfiableItem_Thresh(
  ...
  StringParseError sse_decode_string_parse_error(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      case 0:
        var var_errorMessage = sse_decode_String(deserializer);
        return StringParseError_Generic(errorMessage: var_errorMessage);
      default:
        throw UnimplementedError('');
    }
  }
...
// ignore: invalid_use_of_internal_member
  ...
  void sse_encode_create_tx_error(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case CreateTxError_TransactionNotFound(txid: final txid):
        sse_encode_i_32(0, serializer);
        sse_encode_String(txid, serializer);
      case CreateTxError_TransactionConfirmed(txid: final txid):
        sse_encode_i_32(1, serializer);
        sse_encode_String(txid, serializer);
      case CreateTxError_IrreplaceableTransaction(txid: final txid):
        sse_encode_i_32(2, serializer);
        sse_encode_String(txid, serializer);
      case CreateTxError_FeeRateUnavailable():
        sse_encode_i_32(3, serializer);
  ...
  void sse_encode_ffi_update(FfiUpdate self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_RustOpaque_bdk_walletUpdate(self.opaque, serializer);
  }
  ...
  void sse_encode_list_ffi_policy(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_ffi_policy(item, serializer);
    }
  }
  ...
  void sse_encode_satisfiable_item(
    ...
    switch (self) {
      ...
      case SatisfiableItem_Thresh(
        ...
        sse_encode_i_32(9, serializer);
        sse_encode_list_ffi_policy(items, serializer);
        sse_encode_u_64(threshold, serializer);
      default:
        throw UnimplementedError('');
    }
  ...
  void sse_encode_string_parse_error(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case StringParseError_Generic(errorMessage: final errorMessage):
        sse_encode_i_32(0, serializer);
        sse_encode_String(errorMessage, serializer);
      default:
        throw UnimplementedError('');
