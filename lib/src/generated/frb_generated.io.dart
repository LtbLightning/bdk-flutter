...
class BdkCoreWire implements BaseWire {
  ...
  void wire_bdk_psbt_from_unsigned_tx(
    int port_,
    ffi.Pointer<wire_cst_bdk_transaction> tx,
  ) {
    return _wire_bdk_psbt_from_unsigned_tx(
      port_,
      tx,
    );
  }

  late final _wire_bdk_psbt_from_unsigned_txPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(
                  ffi.Int64, ffi.Pointer<wire_cst_bdk_transaction>)>>(
      'frbgen_bdk_flutter_wire_bdk_psbt_from_unsigned_tx');
  late final _wire_bdk_psbt_from_unsigned_tx =
      _wire_bdk_psbt_from_unsigned_txPtr.asFunction<
